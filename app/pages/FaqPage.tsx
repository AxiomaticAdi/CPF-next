    ...
    <Page>
      ...
      <div className="flex flex-col gap-6 items-center text-center text-pretty">
        ...
        <div>
          ...
          <p className="max-w-xl">
            This is a farm. Please wear shoes that you don&apos;t mind getting
            dirty if you choose to tour the property and bring a jacket or
            sweater for evening events. It tends to get chilly and a little
            windy as the sun sets here on the mountain.
          </p>
        </div>
        <div>
          <h2 className="text-xl font-semibold">
        ...
        <div>
          ...
          <p className="max-w-xl">
            We don&apos;t have a beer and wine license YET so we are not able to
            sell alcohol. However, please feel free to bring a bottle for
            yourself and the people attending with you. We do not charge a
            corkage fee.
          </p>
        </div>
        <div>
