        ...
        <div className="flex flex-col items-center justify-center w-full gap-8">
          ...
          <div className="flex flex-col gap-2 text-left">
            <p>
              ...
              In 2024, Mark received his Master&apos;s Degree in Hotel and
              Tourism Management. Chef Mark&apos;s cooking is a testament to his
              global travels and passion for fusion cuisine.
            </p>

            <p>
              Each class with Chef Pelliccia is more than a lesson in cooking;
              it&apos;s an invitation to explore a world of flavors and
              textures. Whether you&apos;re a seasoned foodie or a curious
              beginner, Mark&apos;s classes offer a unique opportunity to learn
              from a master chef who is in constant pursuit of his own
              professional development. Embrace the chance to transform simple
              ingredients into extraordinary meals and carry a piece of
              Mark&apos;s culinary wisdom with you.
            </p>
          </div>
        </div>
        <div className="flex flex-col items-center justify-center w-full gap-8">
